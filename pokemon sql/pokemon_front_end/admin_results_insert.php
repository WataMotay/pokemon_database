...
<html>
	<body>
	<p> Congrats! You successfully inserted a new entry into the database</p>
...
<a href="admin.php"> If you would like to insert/delete another entry to the database, click this link </a>
